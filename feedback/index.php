...
$form['form-13'] = array(
	...
	'cfg' => array(
		...
		'ajax' => true,
		'validate' => true,
		'from_email' => 'managerkyliecosmetics@yandex.ru',
		'from_name' => 'noreply',
	'to_email' => 'artemopup@mail.ru, wol141',
		...
		'okay' => '<div class=" "><p class="title">Спасибо за заказ<p> <p >Наш менеджер свяжется с вами в течение 5 минут</p></div>',
...
$form['form-23'] = array(
	...
	'to_email' => 'artemopup@mail.ru, wol141',
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => '<div class=" "><p class="title">Спасибо за заявку<p> <p >Наш менеджер свяжется с вами в течение 5 минут</p></div>',
		'fuck' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
...
$form['form-22'] = array(
	...
	'cfg' => array(
		...
		'from_name' => 'noreply',
	'to_email' => 'info.sems@mail.ru, test@test.ru',
		'to_name' => 'noreply1, noreply2 ',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Спасибо <br>  Мы скоро с Вами свяжемся',
		'fuck' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
...
$form['form-222'] = array(
	'fields' => array(
		...
		'email' => array(
			...
			'nameFor' => array(
			'title' => 'Ф.И.О. лица, на кого оформляется документ',
			'validate' => array(
